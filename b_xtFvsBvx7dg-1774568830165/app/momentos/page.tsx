            ...
            <div className="space-y-16">
              {categorizedGallery.map((category, catIndex) => (
                <section key={catIndex}>
                  <h2 className={`text-2xl lg:text-3xl font-black text-white font-heading tracking-[-0.04em] ${category.subtitle ? 'mb-2' : 'mb-8'}`}>
                    {category.title}
                  </h2>
                  {category.subtitle && (
              ...
              {uncategorizedGallery.length > 0 && (
                <section>
                  <h2 className="text-2xl lg:text-3xl font-black text-white font-heading tracking-[-0.04em] mb-8">
                    Otros momentos
                  </h2>
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-[3px]">
