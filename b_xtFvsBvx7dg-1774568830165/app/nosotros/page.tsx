						...
						return (
							...
							>
								<div className={imageFirst ? "lg:order-2" : "lg:order-1"}>
									{!block.hideTitle && (
										<h3 className="text-2xl lg:text-3xl font-black text-white font-heading tracking-[-0.04em] mb-4">
											{block.title}
										</h3>
									)}
									<p className="text-gray-400 leading-relaxed text-base lg:text-lg text-pretty">
										{block.text}
									</p>
								</div>
