	...
	return (
		<section className="relative min-h-[60vh] bg-[#0a0908] flex items-center justify-center px-4 sm:px-6 lg:px-12 pt-24 overflow-hidden">
			...
			<div className="relative z-10 max-w-[1600px] mx-auto w-full text-center">
				...
				>
					<h1 className="font-heading mt-6 text-5xl lg:text-7xl font-black tracking-tighter text-white">
						Quiénes somos
					</h1>
				</motion.div>
			</div>
						...
						return (
							...
							>
								<div className={imageFirst ? "lg:order-2" : "lg:order-1"}>
									{!block.hideTitle && (
										<h3 className="font-heading text-2xl lg:text-3xl font-black text-white tracking-tighter mb-4">
											{block.title}
										</h3>
									)}
		...
		<section className="bg-[#0a0908] py-20 lg:py-32 px-4 sm:px-6 lg:px-12 border-t border-white/[.08]">
			<div className="max-w-[1600px] mx-auto">
				...
				>
					...
					<h2 className="font-heading mt-4 text-4xl lg:text-6xl font-black tracking-tighter text-white">
						Nuestro equipo
					</h2>
				</motion.div>
