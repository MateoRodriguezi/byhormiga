    ...
    <>
      ...
      <main className="min-h-screen bg-[#0a0908] pt-32 pb-24">
        <div className="mx-auto max-w-[980px] px-6 lg:px-12">
          ...
          {post.content ? (
            <article
              className="prose prose-invert prose-lg max-w-none prose-headings:font-black prose-headings:tracking-tighter prose-p:text-gray-300 prose-p:leading-relaxed prose-a:text-white prose-strong:text-white prose-li:text-gray-300 prose-img:rounded-none"
