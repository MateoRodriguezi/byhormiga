  ...
  return (
    <section id="nosotros" className="relative bg-[#0a0908] py-8 sm:py-10 lg:py-14 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-12">
        ...
        >
          <h2 className="text-4xl sm:text-5xl lg:text-7xl font-black font-heading tracking-[-0.04em] text-white">
            Quiénes somos
          </h2>
        </motion.div>
        ...
        >
          <p className="text-lg sm:text-xl lg:text-2xl text-gray-300 leading-relaxed text-pretty">
