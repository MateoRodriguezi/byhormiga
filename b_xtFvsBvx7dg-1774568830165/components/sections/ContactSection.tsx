				...
				>
					...
					<div className="relative">
						...
						<div className="mb-8 sm:mb-12">
							<h3 className="text-2xl sm:text-3xl lg:text-5xl font-black text-white font-heading tracking-[-0.04em] leading-none">
								Trabajemos juntos
							</h3>
							<p className="mt-2 text-2xl sm:text-3xl lg:text-5xl font-black text-stroke font-heading tracking-[-0.04em] leading-none">
								Contáctanos.
							</p>
						</div>
