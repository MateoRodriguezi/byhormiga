	...
	return (
		...
		>
			...
			<div className="relative h-full flex flex-col justify-end p-6 lg:p-8">
				...
				{/* Event name - Large */}
				<h3 className="font-heading text-4xl lg:text-5xl font-black text-white tracking-tighter mb-4 transform group-hover:translate-y-[-8px] transition-transform duration-500">
					{event.name}
				</h3>
